 ...
 * @author SARITA
 */
public class FXMLs_updateController implements Initializable {
    ...
    private void he(ActionEvent event) {
    ...
    else if(event.getSource()==btnupdate)
        {
            ...
            try {
                ...
                StudentDao.update(s1,admin.BRANCH);
